...
const ProgressEvent = require('./ProgressEvent.cjs');
const ErrorEvent = require('./ErrorEvent.cjs');
const WarningEvent = require('./WarningEvent.cjs');
const SuccessEvent = require('./SuccessEvent.cjs');
...
module.exports = {
  ...
  isProgressEvent: EventTypeGuards.isProgressEvent,
  isErrorEvent: EventTypeGuards.isErrorEvent,
  isWarningEvent: EventTypeGuards.isWarningEvent,
  isSuccessEvent: EventTypeGuards.isSuccessEvent,
  isCommandEvent: EventTypeGuards.isCommandEvent
};