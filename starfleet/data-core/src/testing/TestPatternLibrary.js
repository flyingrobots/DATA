...
class TestPatternLibrary {
  ...
  initializePatternCategories() {
    ...
    categories.set('data_validation', {
      ...
      description: 'Patterns for validating data integrity, constraints, and business rules',
    ...
    categories.set('security_testing', {
      ...
      description: 'Patterns for testing security features, RLS policies, and access controls',
      patterns: [],
      commonUseCases: [
    ...
    categories.set('performance_testing', {
      ...
      description: 'Patterns for testing performance characteristics and query efficiency',
      patterns: [],
      commonUseCases: [
    ...
    categories.set('error_handling', {
      name: 'error_handling',
      description: 'Patterns for testing error conditions and exception handling',
      patterns: [],
      commonUseCases: [
    ...
    categories.set('multi_user_scenarios', {
      ...
      description: 'Patterns for testing concurrent access and multi-user interactions',
      patterns: [],
      commonUseCases: [
...
\${foreignKeyTest}`,
    ...
    patterns.set('foreign_key_relationship', {
      ...
      category: 'data_validation',
      description: 'Foreign key relationship validation with referential integrity testing',
...
\${roleTest}`,
      placeholders: ['schema', 'tableName', 'policyName', 'commandType', 'roleTest'],
      metadata: {
        testType: 'security_config',
        complexity: 'medium',
        executionTime: 'fast'
    ...
    patterns.set('multi_user_access_test', {
      ...
      category: 'security_testing',
      description: 'Multi-user access pattern testing data isolation and permissions',
...
\${adminAccessTest}`,
      placeholders: ['schema', 'tableName', 'createUser1Data', 'userFilter', 'adminAccessTest'],
      metadata: {
      ...
      difficulty: 'advanced',
      dependencies: ['test_user_setup', 'rls_enablement_check', 'policy_existence_check']
    });
...
END;`,
    ...
    patterns.set('concurrent_modification_test', {
      ...
      description: 'Test concurrent data modification scenarios and conflict resolution',
