...
describe("Command Integration Tests", () => {
  ...
  describe("Event Validation", () => {
    ...
    it("should validate events against specific class types", () => {
      const progressEventInstance = new ProgressEvent(
        "Test progress",
        null,
        {},
      );
      const errorEventInstance = new ErrorEvent(
        "Test error",
        new Error(),
        null,
        {},
      ...
      const validProgressResult = command.validateEvent(
        progressEventInstance,
        ProgressEvent,
      );
      const invalidResult = command.validateEvent(
        errorEventInstance,
        ProgressEvent,
      );
