...
describe('TestTemplateGenerator - Table Tests', () => {
  ...
  describe('generateTableTemplate', () => {
    it('should generate basic table template with minimal configuration', () => {
      ...
      expect(template.content).toContain('CREATE OR REPLACE FUNCTION test.run_users_table_tests()');
    ...
    it('should handle foreign key relationships', () => {
      ...
      expect(template.content).toContain('Foreign key user_id references users.id');
    });
    ...
    it('should handle tables without optional metadata gracefully', () => {
      ...
      expect(template.content).toContain('TODO: Add constraint validation tests');
    ...
    it('should generate proper SQL formatting', () => {
      ...
      expect(template.content).toContain('SET search_path = test, public, security');
