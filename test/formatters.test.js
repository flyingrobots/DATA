...
import { JUnitFormatter, JSONFormatter } from '../src/lib/test/formatters/index.js';
...
describe('Test Result Formatters', () => {
  ...
  describe('JUnitFormatter', () => {
    it('should format results as valid JUnit XML', () => {
      ...
      expect(xml).toContain('<testcase name="test_get_pets: Should return available pets"');
